...
const Page = () => {
    ...
    const tires = [
        {id: 1, img: "/catalogLanding_TRACKwheel.jpg", text: "High Performance"},
        {id: 2, img: "/croa4-final.jpg", text: "Motorcycle"},
        {id: 3, img: "/bc-rim.jpg", text: "Bicycle"},
        {id: 4, img: "/continental-ultracontact-nxt-pro.jpg", text: "Car and Van"},
        {id: 5, img: "/continental--sc20plus-s--product.jpg", text: "Material Transport"},
        {id: 43, img: "/co-straddlemaster-radial.jpg", text: "Port Operations"},
        {id: 3, img: "/co-em-master-e3-l3-productpictur.jpg", text: "Earthmoving"},
        {id: 2, img: "/co-tractormaster.jpg", text: "Heavy Duty"},
        {id: 32, img: "/ckko1ugcq03go01of5kbase03-tire-p.jpg", text: "All-Season Tires"},
        {id: 2, img: "/roadtec_01_se_1.jpg", text: "Sport"},
        {id: 4, img: "/sportec_m9_rr_1.jpg", text: "Racing"},
        {id: 5, img: "/karoo_street_1.jpg", text: "Adventure"},
        {id: 43, img: "/cq5dam.thumbnail.319.319.jpg", text: "Winter Tires"},
        {id: 3, img: "/cq5dam.thumbnail.319.319 (2).jpg", text: "Comfort"},
        {id: 32, img: "/tire 1 (2).jpg", text: "All-Season Tires"},
        ...
        <>
                ...
                >
                    <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-16 z-20">
                        <p className="mb-4 text-white">
                            The best tire solution near you in Germany, we offer valuable services for you, choose the
                            beste
                        </p>
                        <h1 className="text-2xl md:text-4xl xl:text-7xl text-white font-extrabold mb-4">
                            EXPORT TIRES QUALITY
                        </h1>
                        <button
                ...
                <div className="flex sm:flex-row flex-col 2xl:flex-col gap-5">
                    ...
                    >
                        <div className="absolute inset-0 flex flex-col gap-1 sm:gap-3 2xl:gap-5 justify-center items-start p-8 md:p-16 z-20 text-white">
                            <p>Benefit with us</p>
                            <h2 className="text-xl md:text-2xl xl:text-4xl font-extrabold">PREMIUM QUALITY</h2>
                            <button
                    ...
                    >
                        <div className="absolute inset-0 flex flex-col justify-center gap-1 sm:gap-3 2xl:gap-5 items-start p-8 md:p-16 z-20 text-white">
                            ...
                            <h2 className="text-xl md:text-2xl xl:text-4xl font-extrabold">
                                BEST QUALITY TIRES FOR ALL SEASON
                            </h2>
                            <button
                                className="bg-orange-500 text-white font-bold py-2 px-4 rounded"
                                onClick={() => handleScrollTo("tires-section")}
            ...
            <div className="flex my-8 relative justify-between bg-no-repeat bg-[url('/trieBanner.jpg')] py-12 md:py-24 gap-6 items-center w-full h-full">
                <h1 className="font-semibold z-20 text-2xl text-white md:text-3xl px-4 md:px-24 min-[1800px]:text-4xl relative text-darken lg:pr-10">
                    Take care of your tires 22% discount
                    <br />
